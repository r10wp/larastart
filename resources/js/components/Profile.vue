        ...
        <div class="row">
            <div class="col-md-12 mt-3">
              ...
              <!-- Add the bg color to the header using any of the bg-* classes -->
                <div class="widget-user-header text-white" style="background-image:url('./img/user-cover.jpg'); height:200px">
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane active show" id="settings">
                    <form class="form-horizontal">
                      ...
                      <div class="form-group">
                        <label for="inputName2" class="col-sm-2 control-label">Foto Profile</label>
                        <div class="col-sm-10">
                          <input type="file" @change="updateProfile" class="form-input" name="photo" >
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="inputName2" class="col-sm-12 control-label">Password (Kosongkan jika tidak menginginkan perubahan)</label>
